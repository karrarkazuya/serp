...
class TicketTemplatePolicy
{
    ...
    public function view(User $user, TicketTemplate $_tpl): bool
    {
        return $user->hasPermission('workflow.config.read');
    }
    ...
    public function update(User $user, TicketTemplate $_tpl): bool
    {
        return $user->hasPermission('workflow.config.write');
    }

    public function delete(User $user, TicketTemplate $_tpl): bool
    {
        return $user->hasPermission('workflow.config.unlink');
    }

    public function comment(User $user, TicketTemplate $_tpl): bool
    {
        return $user->hasPermission('workflow.config.write');
    }
}
