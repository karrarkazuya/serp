...
class EmployeeJobGrade extends Model
{
    use HasChatter, SoftDeletes;

    protected $table = 'hr_employee_job_grades';

    protected $fillable = [
        'uuid', 'organizational_structure', 'assignment_type', 'data_status',
        'financial_specialization', 'affective_date',
    ...
    {
        return $this->belongsToMany(Employee::class, 'hr_job_grade_employees', 'job_grade_id', 'employee_id');
    }
