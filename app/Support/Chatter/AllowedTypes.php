...
class AllowedTypes
{
    public const READ_PERMISSIONS = [
        ...
        'App\Models\Employees\RequestSubtype'            => 'attendance.requests.config',
        'App\Models\Employees\RequestBalanceConfig'      => 'attendance.requests.config',
        'App\Models\Employees\EmployeeRequest'           => 'attendance.requests.read',
    ...
    public const WRITE_PERMISSIONS = [
        ...
        'App\Models\Employees\RequestSubtype'            => 'attendance.requests.config',
        'App\Models\Employees\RequestBalanceConfig'      => 'attendance.requests.config',
        'App\Models\Employees\EmployeeRequest'           => 'attendance.requests.write',
    ...
    public const COMPANY_SCOPED = [
        ...
        'App\Models\Employees\EmployeeRequest',
