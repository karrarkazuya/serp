@extends('layouts.app')
@section('title', __('common.edit') . ' ' . $employmentType->name)
...
<div class="flex flex-col h-full bg-gray-50">
    ...
    <div class="flex items-center gap-2">
        <a href="{{ route('employees.employment-types.show', $employmentType) }}" class="px-3 py-1.5 text-sm text-gray-600 bg-white border border-gray-300 rounded hover:bg-gray-50">{{ __('common.cancel') }}</a>
