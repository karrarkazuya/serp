@php
    $val = fn($field, $default = '') => old($field, $reward?->{$field} ?? $default);
    $docTypes = [
...
<div class="p-6 space-y-0">
    ...
    <div x-data="{ specType: @js(old('specialization_type', $reward->specialization_type ?? 'amount')) }">
        <div class="flex items-center gap-4 py-1.5 border-b border-gray-100">
    ...
    <div class="flex items-center gap-4 py-1.5">
        ...
        <div class="flex-1">
            @if(isset($reward) && $reward->file_path && $reward->attachedFile)
