...
<div class="flex flex-col h-full bg-gray-50">
    ...
    <div class="flex-1 overflow-y-auto">
        <div class="bg-white mx-4 my-4 rounded-xl border border-gray-200 shadow-sm p-6">
            ...
            @endif
            <form id="category-form" method="POST" action="{{ route('employees.categories.update', $employeeCategory) }}">
                @csrf
                @method('PUT')
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4">
                    ...
                    <div x-data="{ color: @js(old('color', $employeeCategory->color ?? '#714B67')) }">
