@extends('layouts.app')
@section('title', 'Edit ' . $departureReason->name)
...
<div class="flex flex-col h-full bg-gray-50">
    <div class="bg-white border-b border-gray-200 px-4 py-2 flex items-center gap-3 shrink-0">
        ...
        <div class="ms-auto flex items-center gap-2">
            <a href="{{ route('employees.departure-reasons.show', $departureReason) }}" class="px-3 py-1.5 text-sm text-gray-600 bg-white border border-gray-300 rounded hover:bg-gray-50">Cancel</a>
