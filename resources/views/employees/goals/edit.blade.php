@extends('layouts.app')
@section('title', __('common.edit') . ' ' . $goal->name)
...
<div class="flex flex-col h-full bg-gray-50">
    <div class="bg-white border-b border-gray-200 px-4 py-2 flex items-center gap-3 shrink-0">
        ...
        <div class="flex items-center gap-2">
            <a href="{{ route('employees.goals.show', $goal) }}" class="px-3 py-1.5 text-sm text-gray-600 bg-white border border-gray-300 rounded hover:bg-gray-50">{{ __('common.cancel') }}</a>
