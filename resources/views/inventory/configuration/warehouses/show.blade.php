...
<div class="flex flex-col h-full bg-gray-50">
    ...
    <x-toolbar
        ...
        <x-slot:actions>
            <div class="flex items-center gap-2">
                ...
                <a href="{{ route('inventory.config.warehouses.edit', $warehouse) }}" class="px-3 py-1.5 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded hover:bg-gray-50">Edit</a>
                @if($warehouse->active)
                ...
                <div x-data="{ confirming: false }">
                    <form method="POST" action="{{ route('inventory.config.warehouses.delete', $warehouse) }}">
                        ...
                        <div x-show="confirming" style="display:none" class="flex items-center gap-1.5">
                            <span class="text-xs text-red-600">Delete warehouse?</span>
    ...
    <div class="flex-1 overflow-y-auto">
        <div class="bg-white mx-4 mt-4 mb-4 rounded-xl border border-gray-200 shadow-sm p-6">
            ...
            @foreach([
                ['Short Name', $warehouse->code],
                ['Company', $warehouse->company?->name],
                ['Stock Location', $warehouse->stockLocation?->complete_name],
            ] as [$label, $value])
            ...
            <div class="mt-6">
                <h3 class="text-sm font-semibold text-gray-700 mb-3">Operation Types</h3>
