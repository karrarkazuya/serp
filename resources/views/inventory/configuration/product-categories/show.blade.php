...
<div class="flex flex-col h-full bg-gray-50">
    ...
    <x-toolbar
        ...
        <x-slot:actions>
            <div class="flex items-center gap-2">
                ...
                <a href="{{ route('inventory.config.product-categories.edit', $productCategory) }}" class="px-3 py-1.5 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded hover:bg-gray-50">Edit</a>
                @endcan
    ...
    <div class="flex-1 overflow-y-auto">
        <div class="bg-white mx-4 mt-4 mb-4 rounded-xl border border-gray-200 shadow-sm p-6">
            ...
            @foreach([
                ['Parent', $productCategory->parent?->complete_name],
                ['Removal Strategy', ucwords(str_replace('_', ' ', $productCategory->removal_strategy))],
                ['Costing Method', ucwords(str_replace('_', ' ', $productCategory->costing_method))],
            ] as [$label, $value])
