    ...
    <form method="POST" action="{{ route('accounting.currencies.store') }}">
        ...
        <x-toolbar>
            <x-slot:breadcrumb>
                ...
                <span class="text-sm font-semibold text-gray-800">New Rate</span>
            </x-slot:breadcrumb>
            <x-slot:actions>
                <div class="flex items-center gap-2">
                    <a href="{{ route('accounting.currencies.index') }}" class="px-3 py-1.5 text-sm text-gray-600 border border-gray-300 rounded hover:bg-gray-50">Cancel</a>
