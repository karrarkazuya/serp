    ...
    <x-toolbar>
        ...
        <x-slot:actions>
            <div class="flex items-center gap-2">
                <a href="{{ route('accounting.tax-groups.show', $taxGroup) }}" class="px-3 py-1.5 text-sm text-gray-600 border border-gray-300 rounded hover:bg-gray-50">{{ __('accounting.btn_cancel') }}</a>
