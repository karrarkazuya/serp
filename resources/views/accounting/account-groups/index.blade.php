...
<div class="flex flex-col h-full bg-gray-50">
    ...
    @if(isset($groups))
    <x-list :grouped="true" empty-text="No account groups found.">
        <x-slot:columns>
        ...
        @empty
        <tbody>
            <tr><td colspan="99" class="px-4 py-20 text-center text-sm text-gray-400">No account groups found.</td></tr>
        </tbody>
        @endforelse
    </x-list>
