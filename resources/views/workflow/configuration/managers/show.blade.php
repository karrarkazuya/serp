@extends('layouts.app')
@section('title', $manager->workflowUser?->user?->name ?? __('workflow.manager_role'))
...
<div class="flex flex-col h-full bg-gray-50">
    ...
    <div class="flex-1 overflow-y-auto">
        ...
        <div class="bg-white mx-4 mt-4 mb-4 rounded-xl border border-gray-200 shadow-sm">
            <div class="px-6 py-5">
                <div class="mb-6">
                    <h1 class="text-3xl font-bold text-gray-900">{{ $manager->workflowUser?->user?->name ?? __('workflow.manager_role') }}</h1>
                ...
                <div class="flex items-center gap-4 py-2 border-b border-gray-100">
                    <label class="w-36 shrink-0 text-sm text-gray-500">{{ __('workflow.default_dept_label') }}</label>
                ...
                <div class="flex items-start gap-4 py-2 border-b border-gray-100">
                    <label class="w-36 shrink-0 text-sm text-gray-500 pt-0.5">{{ __('workflow.departments_title') }}</label>
