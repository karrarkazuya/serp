@extends('layouts.app')
@section('title', 'Edit Ticket Template')
...
<div class="flex flex-col h-full bg-gray-50">
    <div class="bg-white border-b border-gray-200 px-4 py-2 flex items-center gap-3 shrink-0">
        ...
        <div class="ml-auto flex items-center gap-2">
            <a href="{{ route('workflow.config.ticket-templates.show', $ticketTemplate) }}" class="px-3 py-1.5 text-sm text-gray-600 bg-white border border-gray-300 rounded hover:bg-gray-50">Discard</a>
    ...
    <div class="flex-1 overflow-y-auto">
        <div class="bg-white mx-4 my-4 rounded-xl border border-gray-200 shadow-sm">
            <form id="template-form" method="POST" action="{{ route('workflow.config.ticket-templates.update', $ticketTemplate) }}">
                ...
                <div class="p-6">
                    <div class="mb-6">
                        <input type="text" name="name" value="{{ old('name', $ticketTemplate->name) }}" required placeholder="Template Name"
