...
<div class="flex flex-col h-full bg-white">
    <div class="flex flex-wrap items-center gap-3 px-4 py-2 border-b border-gray-200 shrink-0">
        ...
        <a href="{{ route('workflow.config.groups.create') }}" class="px-4 py-2 bg-[#714B67] hover:bg-[#5c3d55] text-white text-sm font-semibold rounded shadow-sm">New</a>
        @endcan
        <span class="text-xl font-semibold text-gray-700">Groups</span>
        <x-search
    ...
    @endif
    <x-list :paginator="$groups" empty-text="No groups yet.">
        <x-slot:columns>
