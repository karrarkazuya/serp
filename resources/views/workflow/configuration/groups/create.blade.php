@extends('layouts.app')
@section('title', __('workflow.new_group'))
...
<div class="flex flex-col h-full bg-gray-50">
    <div class="bg-white border-b border-gray-200 px-4 py-2 flex items-center gap-3 shrink-0">
        <div class="flex flex-col leading-tight">
            ...
            <span class="text-sm font-semibold text-gray-800">{{ __('workflow.new_group') }}</span>
        </div>
    ...
    <div class="flex-1 overflow-y-auto">
        <div class="bg-white mx-4 my-4 rounded-xl border border-gray-200 shadow-sm">
            <form id="group-form" method="POST" action="{{ route('workflow.config.groups.store') }}">
                ...
                <div class="p-6">
                    <div class="mb-6">
                        <input type="text" name="name" value="{{ old('name') }}" required placeholder="{{ __('workflow.group_name_placeholder') }}"
