...
<div class="flex flex-col h-full bg-gray-50">
    <div class="bg-white border-b border-gray-200 px-4 py-2 flex items-center gap-3 shrink-0">
        ...
        <div class="ml-auto flex items-center gap-2">
            @can('update', $group)
            <a href="{{ route('workflow.config.groups.edit', $group) }}" class="px-3 py-1.5 text-sm border border-gray-300 rounded hover:bg-gray-50">Edit</a>
            @endcan
        </div>
    </div>
        ...
        <div class="bg-white mx-4 mt-4 mb-4 rounded-xl border border-gray-200 shadow-sm">
            <div class="px-6 py-5">
                ...
                <div class="flex items-start gap-4 py-2 border-b border-gray-100">
                    <label class="w-36 shrink-0 text-sm text-gray-500 pt-0.5">Workflow Users</label>
