        ...
        <div class="p-6 space-y-5">
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-6">
                <div class="flex items-center gap-5">
                    <div class="w-16 h-16 rounded-xl bg-[#714B67]/10 flex items-center justify-center text-xl font-bold text-[#714B67] shrink-0">
                ...
                <div class="bg-white rounded-xl border border-gray-200 p-5">
                    ...
                    <dl class="space-y-3">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <a href="{{ $company->website }}" target="_blank" class="text-sm text-[#714B67] hover:underline">{{ $company->website }}</a>
                        </div>
                        @endif
                    </dl>
                    @else
