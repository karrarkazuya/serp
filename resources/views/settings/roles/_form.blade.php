...
<div class="bg-white rounded-xl border border-gray-200 p-6">
    <h2 class="text-sm font-semibold text-gray-700 mb-4">Role Details</h2>
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
            ...
            <p class="mt-1 text-xs text-gray-400">Lowercase letters, numbers, underscores only.</p>
...
<div class="bg-white rounded-xl border border-gray-200 p-6">
    <div class="flex items-center justify-between mb-4">
        <h2 class="text-sm font-semibold text-gray-700">Permissions</h2>
        <div class="flex gap-2">
            <button type="button" onclick="document.querySelectorAll('input[name=\'permissions[]\']').forEach(c => c.checked = true)"
                    class="text-xs text-purple-600 hover:text-purple-700 font-medium">Select All</button>
            <span class="text-gray-300">|</span>
            <button type="button" onclick="document.querySelectorAll('input[name=\'permissions[]\']').forEach(c => c.checked = false)"
                    class="text-xs text-gray-500 hover:text-gray-700 font-medium">Clear All</button>
        </div>
    </div>
    ...
    <div class="mb-5">
        <h3 class="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2 flex items-center gap-2">
            ...
            <span class="text-gray-300 font-normal lowercase">{{ $perms->count() }} permissions</span>
        </h3>
